...
| --- | --- |
| Accurate | “Concurrent multi-pending family selection is on the host product path. Live multi-pending concurrent family acceptance under real Pi is not complete. Host model-slot limits apply.” |
